...
export function ReviewContent({
  ...
  return (
    <div className="max-w-4xl mx-auto h-full flex flex-col py-6">
      {/* Header - sticky top */}
      ...
      <div className="flex-1 overflow-y-auto min-h-0 mt-6 space-y-6">
        {/* Empty state */}
        {filtered.length === 0 ? (
          <Card>
      ...
      {filtered.length > 0 && current && currentQ && (
        <div className="shrink-0 mt-6 bg-background pt-1 border-t">
